<template>
  <div class="infoList">
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="father" label="下级" align="center">
      </el-table-column>
      <el-table-column prop="mather" label="上级" align="center">
      </el-table-column>
    ...
    <el-dialog :title="state ? '添加管理员信息' : '修改管理员信息'" :visible.sync="dialogFormVisible" width="500px">
      <el-form :model="form" :rules="rules" ref="form">
        ...
        <el-form-item label="下级" :label-width="formLabelWidth" prop="father">
          <el-input v-model="form.father" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="上级" :label-width="formLabelWidth" prop="mather">
