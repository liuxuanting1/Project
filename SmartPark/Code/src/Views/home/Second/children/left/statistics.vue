<template>
  <div class="alarmPie">
    <Lease_title>园区入住统计</Lease_title>
...
export default defineComponent({
  setup() {
    ...
    onMounted(() => {
      setInterval(() => {
        options.value.series[0].data.sort(function (a: any, b: any) {
          return Math.random() > 0.5 ? -1 : 1;
        });
        options.value.series[1].data.sort(function (a: any, b: any) {
          return Math.random() > 0.5 ? -1 : 1;
        });
      }, 5000);
    });
